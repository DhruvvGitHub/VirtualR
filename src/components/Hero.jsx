...
const Hero = () => {
  return (
    <div className="hero w-full h-[110vh]">
      <div className="container flex flex-col gap-12 items-center pt-16">
        ...
        <div className="videos flex items-center gap-10">
            <video className="w-100 h-80 overflow-hidden rounded-md border-2 border-orange-500 object-cover"  loop autoPlay muted src={video1}></video>
            <video className="w-100 h-80 overflow-hidden rounded-md border-2 border-orange-500 object-cover"  loop autoPlay muted src={video2}></video>
        </div>
      </div>
    </div>
  );
